...
### 外壳采购记录（新增）
- **填默认**：供应商=`鸿运电子`、采购时间=今天。
- **必填**：外壳名称；数量/价格/交期/到货→后补📥。生产计划→必问。

### IC采购记录（新增）
- **填默认**：状态=`未下单`。
- **必问**：物料名称、供应商(14 选项：之安传感/世维电子/禾讯通信/鼎晟科技/创科新源/华远驱动/睿通微电子/如微半导体/言和科技/亿源创芯-马达散料/智法电子/芯通达/环宇电子/跃之微电子)、生产计划。
- 下单时间未提及→留空后补（不默认今天）。
...
### PCBA半成品采购记录（新增）
- **填默认**：供应商=`环宇电子`、状态=`未下单`(有描述按描述/谈判中)。
- **必填**：物料名称、生产计划。数量/花销/交期/到货→后补📥。

### 组装料采购记录（新增）
- **填默认**：状态=`谈判中`。
- **必问**：供应商(言和科技/环宇电子/聚力半导体/引磁科技/禾讯通信/正扬精密/欣声科技/银赛电子/鑫隆科技/耐达精密)、采购花销、生产计划。交期/到货→后补📥。
...
- **必问**：物料名称、供应商(环宇电子/触智智能/联犇物联物联)、数量、采购花销、生产计划。交期/到货→后补📥。
